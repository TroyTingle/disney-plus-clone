...
export default function Movies() {
  ...
  async function getShows(category) {
    const response = await getAllShows('movie', category);
    setShows(response);
  }
  ...
  return (
    <>
      <Head>
        <title>Movies | Disney+ Clone</title>
      </Head>
      <main>
        <Header />
        <div className='flex pt-4 pb-2 text-white'>
          ...
          >
            ...
            <option id='28|12'>Action/Adventure</option>
            <option id='16'>Animation</option>
            <option id='35'>Comedy</option>
            <option id='99'>Documentary</option>
            <option id='18'>Drama</option>
            <option id='10749'>Romance</option>
            <option id='878'>Science Fiction</option>
            <option id='53'>Thriller</option>
